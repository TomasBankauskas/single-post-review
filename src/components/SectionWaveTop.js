...
export default class SectionWaveTop extends React.Component {
    render() {
        return (
            <div className="wave-top">
                <svg width="2060" height="137" viewBox="0 0 2060 137" xmlns="http://www.w3.org/2000/svg">
                    <title>Section Top Wave</title>
                    <g fill="none" fill-rule="evenodd">
                        <path
                            ...
                            fill="#E5E6FF"
                        />
                        <path d="M0 0h2060v63.824C1026.921-96.01 1177.132 224.25 0 50.822V0z" fill="#FFF" />
                    </g>
                </svg>
            </div>
        );
