...
import { Sticky as Header } from './HeaderHome';
...
export default class HomeLayout extends React.Component {
    render() {
        ...
        const isHomepage = _.get(this.props, 'pageContext.frontmatter.template') === 'home';
        ...
        return (
            <React.Fragment>
                ...
                <div id="page" className="site">
                    ...
                    {isHomepage && <div id="bg-diag" className="bg-diag" />}
